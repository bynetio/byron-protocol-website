      ...
      <section id="layers" className="bg-bckg-blue text-left">
        <div className="flex max-w-6xl mx-auto">
          ...
          <div className="mt-12 text-lg">
            ...
            <h4 className="text-sm text-blue uppercase font-bold tracking-[.5em] mb-6 mt-52">Meet protocol layers</h4>
            <h2 className="text-[56px] font-bold leading-relaxed">Matchmaking Engine</h2>
            ...
            <h4 className="text-sm text-blue uppercase font-bold tracking-[.5em] mb-6 mt-52">Meet protocol layers</h4>
            <h2 className="text-[56px] font-bold leading-relaxed">Problem solving with Bynet Protocol</h2>
              <ul className="mt-8 text-lg">
                <li>
                <img src={dot1} alt="" ></img>
