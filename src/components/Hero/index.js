...
const ParallaxImagesContainer = ({ backgroundImage, layers }) => {
  ...
  return (
    ...
    <div className="flex justify-center flex-wrap md:flex-nowrap gap-x-6 gap-y-10">
    <span className="stitch"><a href="#layers" className="btn-primary">Explore Protocol<img className="mx-auto inline-block" src={arrow} alt=""/></a></span>
    <span className="stitch"><a href="https://docsend.com/view/jdibiwr5mxdtfgd2" target="blank" className="btn-secondary">See Pitchdeck</a></span>
    </div>
    </div>
    </section>
  );
