      ...
      <section id="callToAction" className="">
        ...
        <div className="mx-6 md:mx-8 xl:mx-auto flex flex-wrap-reverse max-w-6xl">
          ...
          <h4 className="text-sm text-blue uppercase font-bold tracking-[.5em] my-6">Get started</h4>
            ...
            <a href="https://docsend.com/view/taamqqwdehwhfvhb" rel="noopener noreferrer" target="blank" className="block w-fit mb-12 xl:mb-36 bg-gradient-to-r from-dark-blue to-light-blue hover:from-light-blue hover:to-dark-blue text-white font-bold py-2 px-4 rounded-lg">Explore our Whitepaper</a>
          </div>
